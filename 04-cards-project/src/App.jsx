...
const App = () => {
  ...
  return (
    <div className='parent'>
      {jobopening.map (function(elem,index){
        return<Card company={elem.companyName} datePosted={elem.datePosted} post={elem.post} tag1={elem.tag1} tag2={elem.tag2} brandLogo={elem.brandLogo} pay={elem.pay} tag2={elem.tag2} />
      }
